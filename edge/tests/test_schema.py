...
class TestSchema:
    @pytest.mark.parametrize(
        "file_name", [("1.json"), ("2.json"), ("3.json"), ("4.json"), ("3v1.json")]
    )
    def test_station_find_schema(self, file_name: str):
        ...
        :type file_name: str
        """
        file_path = os.path.join(base_path, "station_find", file_name)
    ...
    def test_data_count_station_real_data_schema(self, file_name: str):
        ...
        :type file_name: str
        """
        file_path = os.path.join(base_path, "data_count_station_real_data", file_name)
        with open(file_path, "r") as file:
            data = yaml.safe_load(file)
